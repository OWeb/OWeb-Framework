...
if (!defined('OWEB_DEBUG'))
    define('OWEB_DEBUG', "1");

if (!defined('OWEB_DIR_MAIN'))
    define('OWEB_DIR_MAIN', "../OWeb_src/OWeb");
if (!defined('OWEB_CONFIG'))
    define('OWEB_CONFIG_DIR', "../OWeb_src/confing");
if (!defined('OWEB_CONFIG'))
    define('OWEB_CONFIG', "config.ini");
if (!defined('OWEB_DIR_LANG'))
    define('OWEB_DIR_LANG', "lang");
if (!defined('OWEB_DEFAULT_LANG_DIR'))
    define('OWEB_DEFAULT_LANG_DIR', OWEB_DIR_MAIN . "/lang");

if (!defined('OWEB_DIR_VIEWS'))
    define('OWEB_DIR_VIEWS', OWEB_DIR_MAIN . "/views");
if (!defined('OWEB_DIR_SVUES'))
    define('OWEB_DIR_SVUES', OWEB_DIR_MAIN . "/sVue");
if (!defined('OWEB_DIR_MODELS'))
    define('OWEB_DIR_MODELS', OWEB_DIR_MAIN . "/models");
if (!defined('OWEB_DIR_CONTROLLERS'))
    define('OWEB_DIR_CONTROLLERS', OWEB_DIR_MAIN . "/controllers");
if (!defined('OWEB_DIR_PAGES'))
    define('OWEB_DIR_PAGES', "pages");
if (!defined('OWEB_DIR_EXTENSIONS'))
    define('OWEB_DIR_EXTENSIONS', OWEB_DIR_MAIN . '/extensions');
if (!defined('OWEB_DIR_TEMPLATES'))
    define('OWEB_DIR_TEMPLATES', 'templates');

// Les controleurs par default
if (!defined('OWEB_DEFAULT_PAGE'))
    define('OWEB_DEFAULT_PAGE', 'home');
if (!defined('OWEB_DIR_DATA'))
    define('OWEB_DIR_DATA', 'sources/data');

// Les Fichier pour le HTML par Default
if (!defined('OWEB_HTML_DIR_CSS'))
    define('OWEB_HTML_DIR_CSS', 'sources/css');
if (!defined('OWEB_HTML_DIR_JS'))
    define('OWEB_HTML_DIR_JS', 'sources/js');

if (!defined('OWEB_HTML_URL_IMG'))
    define('OWEB_HTML_URL_IMG', 'sources/files');
